...
<nav class="category-nav">
    <form id="categoryForm">
        <ul>
            ...
            <li><input type="checkbox" id="checkboxArmes" name="category[]" value="R" class="category-checkbox" onclick="filterItems()"> <label for="checkboxArmes">Armes</label></li>
            <li><input type="checkbox" id="checkboxArmures" name="category[]" value="A" class="category-checkbox" onclick="filterItems()"> <label for="checkboxArmures">Armures</label></li>
    ...
    for (var i = 0; i < checkboxes.length; i++) {
        if (checkboxes[i].checked) {
            if (checkboxes[i].value === "") {
                ...
                // Désélectionner et désactiver les autres cases
                // for (var j = 0; j < checkboxes.length; j++) {
                //     if (checkboxes[j] !== aucunCheckbox) {
                //         checkboxes[j].checked = false;
                //     }
