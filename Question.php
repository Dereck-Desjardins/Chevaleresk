  ...
  $content = <<<HTML
    <div class="content">
        ...
        <div class="modal-content">
          ...
          <button onclick="Back($id_enigme,1)">Retourné à la boutique</button>
          <button onclick="Back($id_enigme,2)">Faire une autre question</button>
          <button onclick="Back($id_enigme,3)">Choisir une autre difficulté</button>
        </div>
...
?>
<script>
  function Back(nbr, choix) {
    //console.log(nbr)
    window.location.href = "confirmQues.php?chx=" + choix + " &id=" + nbr;
  }
